...
export class Convert {
    public static toWelcome1(json: string): Welcome1 {
        return cast(JSON.parse(json), r("Welcome1"));
    }

    public static welcome1ToJson(value: Welcome1): string {
        return JSON.stringify(uncast(value, r("Welcome1")), null, 2);
    }
}
